    ...
    <table width=100% style=" border-collapse: separate; border-spacing: 15px;" border=1>  
        <div class="templatemo_homewrapper">
          <tr>
            ...
            <td align="left"><input type="email" size="30"  name="email" > </td>
          </tr>
          <tr>
          ...
          <tr>
              ...
              <td align="left"><input type="password" size="30"  name="password" pattern=".{6,30}">(min 6 chars) </td>
          </tr>
          <tr>
              <td align="right">Confirm Password</td>
              <td align="left"><input type="password" size="30"  name="cpassword" pattern=".{6,30}"> (min 6 chars)</td>
          </tr>
          <tr>
            <td align="center" colspan=2>              
              <button type="submit" style="width:75px;height:30px;background-color: #E6610A;">Register</button>
            </td>
          </tr>
         </div>
      </table> 
