  ...
  <div class="slider-cap">
      ...
      <div class="span_2 column" >
        <table  width=100% style=" border-collapse: separate; border-spacing: 15px; font-size:20px; text-align:left;" >
          ...
          <tr><td><a class="menu" href="Fans.jsp">Fans</a></td></tr>
          <tr><td><a class="menu" href="FanOf.jsp">Fan Of</a></td></tr>
      ...
      <div class="span_10 column">
          ...
          <tr style="border-style:hidden;"><th style="text-align:center;">FAN OF</th></tr>
          <tr><td>dsf</td></tr>
          </table> 
      </div>
