  ...
  <div class="slider-caption">
    <table width=100% >  
      <div class="templatemo_homewrapper">
        <tr >
          <td ><div class="templatemo_hometitle" >TRENDING SONGS</div></td>
          <td ><div class="templatemo_hometitle"><ul align=right >TRENDING TUNES</ul></div></td>
        </tr>
        <tr>
          <td>
            <div class="templatemo_hometext" ><!-- class="col-lg-4"> -->
              <ul class="slides" align=left>
                <li>SONG 1</li>
                <li>SONG 2</li>
                <li>SONG 3</li>
                <li>SONG 4</li>
...
<div class="templatemo_footerwrapper">
  <div class="container">
    <div class="row">
      <div class="col-md-12">Copyright @myumix: 2016 </div>
    </div>
  </div>
</div>
<!-- footer end -->
